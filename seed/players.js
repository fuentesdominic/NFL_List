...
const main = async () => {
    ...
    const players = [
       ...
       { name: 'Jameis Winston', age: '29', position: 'Quarterback', name: 'Alvin Kamara', age: '27', position: 'Running Back'},
       { name: 'Marcus Mariota', age: '29', position: 'Quarterback', name: 'Kyle Pitts', age: '22', position: 'Tight End'},
